...
func demo4() {
	t, err := template.ParseFiles("/MyProject/goProject/src/base5_io/sss/tpl.html")
	if err != nil {
		log.Fatal(err)
	}
	...
	fmt.Println("=========================================")
	t, err = template.ParseFiles("/MyProject/goProject/src/base5_io/sss/index.html", "/MyProject/goProject/src/base5_io/sss/header.html", "/MyProject/goProject/src/base5_io/sss/footer.html")
	if err != nil {
		log.Fatal(err)
	}
